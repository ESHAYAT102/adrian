...
describe("admin dashboard stats and releases", () => {
  ...
  it("wires release creation and admin dashboard UI", () => {
    ...
    expect(adminDashboard).toContain("@/components/ui/select")
    expect(adminDashboard).toContain("<Select")
    expect(adminDashboard).toContain("<SelectTrigger")
    expect(adminDashboard).toContain("<SelectContent")
    expect(adminDashboard).not.toContain("<select")
    expect(adminDashboard).toContain("Dashboard date range")
    expect(adminDashboard).not.toContain("stats.filters.map((filter) => (\n            <button")
    expect(adminDashboard).toContain("<SelectItem")
